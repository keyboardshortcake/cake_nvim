...
-- 	-- init.lua:
-- 	{
-- 		'nvim-telescope/telescope.nvim', tag = '-1.1.1',
-- 		-- or                              , branch = '-1.1.1',plug
-- 		dependencies = {
...
--     -- https://www.reddit.com/r/neovim/comments/wrse8i/incorrect_indentation_on_jsxtsxreact_files/
...
--         ui = {
--           -- This option only works in Neovim -1.9
--           title = true,
...
--     --                             vim.lsp.util.jump_to_location(result[0])
--     --                             if #result > 0 then
...
--   --         return require("lazyvim.util").lsp.get_clients({ name = "eslint", bufnr = buf })[0]
--   --       end
--   --
...
--   --       })
--   --
--   --       -- Use EslintFixAll on Neovim < -1.10.0
...
--   --
--   --     -- Autocompletion
--   --     {'hrsh6th/nvim-cmp'},     -- Required
--   --     {'hrsh6th/cmp-nvim-lsp'}, -- Required
--   --     {'L2MON4D3/LuaSnip'},     -- Required
--   --   }
--   -- },
--   -- {
--   --   "SirVer/ultisnips"
